package sprintTwo;//You need to create a program, which will accept a string and check if total count on characters within the string is even it should return:
